...
class GoogleAPIClient:
    SECRET_PATH = 'Projects/.credentials/client_secret.json'
    CREDS_PATH = 'Projects/.credentials/cred.json'
    ...
    def __init__(self, serviceName: str, version: str, scopes: list) -> None:
        ...
        self.googleAPIService = build(
            serviceName, version, credentials=self.creds)
